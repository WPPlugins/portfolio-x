...
$instance = new QcSupportAndPromoPage('qcpx_portfolio-qcld-support');

if( is_admin() )
{
	$instance->plugin_menu_slug = "edit.php?post_type=qcpx_portfolio"; //Edit Value
	$instance->plugin_name = "Portfolio X"; //Edit Value
